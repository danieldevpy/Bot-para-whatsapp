menu = ['Seja bem vindo ao modo administrador, caso queira sair, digite 0!',
        '*1*: Configurar um número', '*2* Desativar bot para um número especifico',
...
detail = ['Operação realizada, deseja mais alguma coisa?', '*1*. SIM', '*2*. NÃO']

message_finality = ['Entendido, você voltou para o menu principal e suas configurações foram resetadas!']